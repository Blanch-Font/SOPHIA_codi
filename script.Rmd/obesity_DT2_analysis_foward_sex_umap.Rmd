...
bbdd_covar <- bbdd_covar %>% filter(obesity_BMI == "Obesity")
```
...
clusters_men <- clusters_men %>% filter(name != "Cluster 9", name != "Cluster 8")
...
clusters_women$name <- relevel(clusters_women$name, ref = "Cluster 1")
...
clusters_men <- diseases[[1]] 
clusters_men <- clusters_men %>% filter(name != "Cluster 8", name != "Cluster 9", name != "Cluster 6")
clusters_men$name <- as.factor(clusters_men$name)
clusters_men$name <- relevel(clusters_men$name, ref="Cluster 4") #REFERENCIA MAYOR SUPERVIVENCIA
...
clusters_women$name <- as.factor(clusters_women$name)
clusters_women <- clusters_women %>% filter(name != "Cluster 7", name != "Cluster 4")
...
clusters_men <- diseases[[1]] 
clusters_men <- clusters_men %>%filter(name != "Cluster 2", name != "Cluster 1", name != "Cluster 9", name != "Cluster 8")
clusters_men$name <- as.factor(clusters_men$name)
...
clusters_women <- diseases[[2]]
clusters_women$name <- as.factor(clusters_women$name)
clusters_women <- clusters_women %>% filter(name != "Cluster 1",  name != "Cluster 7",  name != "Cluster 4")
clusters_women$name <- relevel(clusters_women$name, ref = "Cluster 5")
...
clusters_women$clusters <- relevel(clusters_women$clusters, ref = 3)
...
clusters_men <- bbdd_clusters_6 %>% filter(sex_female=="Men", clusters != 4) #FILTRO CUANDO NO APARECE EVENTO
...
clusters_men <- bbdd_clusters_6 %>% filter(clusters != 4, sex_female=="Men") #FILTRO CUANDO NO APARECE EVENTO
clusters_men$clusters <- relevel(clusters_men$clusters, 1) #REFERENCIA MAYOR SUPERVIVENCIA

clusters_women <- bbdd_clusters_6 %>% filter(clusters != 2, clusters != 3, clusters != 6, sex_female=="Women")
...
clusters_men <- bbdd_clusters_6 %>% filter(sex_female=="Men", clusters != 5) #FILTRO CUANDO NO APARECE EVENTO
clusters_men$clusters <- relevel(clusters_men$clusters,ref = 6) #REFERENCIA MAYOR SUPERVIVENCIA
